...
#define MT_MSP430_USE_WDT_COMPILE_TIME_CALLBACKS /* if commented in the lib will register WDT Interrupts with callbacks known at compile time - >for max performance  */
